...
CONF_ENABLED_MCPS = "enabled_mcps"
CONF_ENABLED_SKILLS = "enabled_skills"
CONF_HARNESS_PROFILE = "harness_profile"
CONF_SESSION_ENV = "session_env"
...
DEFAULT_ENABLED_MCPS: list[str] = []
DEFAULT_ENABLED_SKILLS: list[str] = []
DEFAULT_HARNESS_PROFILE = ""
DEFAULT_SESSION_ENV: dict[str, str] = {}
